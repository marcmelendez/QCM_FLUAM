...
/******* Added by Adolfo *******/
const string wfreqWall="freqWall";
const string wmassWall="massWall";
const string wFWall="FWall";
const string wkWall="kWall";
...
bool loadDataMain(int argc, char* argv[]){
  ...
  while(!fileinput.eof()){
    ...
    else if(word==wfreqWall){ /** Added by Adolfo **/
      freqWall=1;
      fileinput >> freqWall;
    }
    else if(word==wmassWall){ /** Added by Adolfo **/
      massWall=1;
      fileinput >> massWall;
    }
    else if(word==wFWall){ /** Added by Adolfo **/
      FWall=1;
      fileinput >> FWall;
    }
      else if(word==wkWall){ /** Added by Adolfo **/
      kWall=1;
      fileinput >> kWall;
     }
