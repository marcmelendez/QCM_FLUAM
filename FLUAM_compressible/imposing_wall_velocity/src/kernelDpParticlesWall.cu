...
__global__ void kernelDpParticlesWall_shearRate(double* densityGPU,
  ...
  /*** Suponemos que la y de Vx esta en mitad de la celda, y que Vwall 
      esta en el limite inferior de la primera celda  ***/
  ...
  /*** Suponemos que la y de Vx esta en mitad de la celda, y que Vwall 
      esta en el limite inferior de la primera celda (o en el limite superior de la celda 0) ***/
  dydvxGPU[i] = 2.0*invdxGPU * (vx - vxWall);
     // dydvxGPU[i] = invdxGPU * (-11.0/6.0 * vxWall + 3.0 * vx - 3.0/2.0 * vx4 + 1.0/3.0 * vx44 );
