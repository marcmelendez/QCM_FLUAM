...
__global__ void kernelFeedGhostCellsParticlesWall2_time(int* ghostToPIGPU, 
						   int* ghostToGhostGPU,
						   double* densityGPU, 
						   double* densityPredictionGPU,
						   double* vxGPU, 
    ...
    if(fy==0){
      ...
      vxGPU[ighost] = 2*vxWall_time - vxGPU[ighost+mxtGPU];
      vxPredictionGPU[ighost] = 2*vxWall_time - vxPredictionGPU[ighost+mxtGPU];
